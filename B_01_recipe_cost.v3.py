...
while True:
    ...
    brought = num_check(f"How much did you buy (in the same units as before): ")
    ...
    print(f"You have got ingredient worth of", each_ingredient_per_dollar * amount, f"(It is calculated on the "
