...
def unit_check(question, valid_answers=('kg', 'g', 'grams', '')):
    while True:
...
while True:
    ...
    if ingredient == "xxx":
        ...
        # using units
    units = unit_check(f"What is your units for this ingredient: ")

    amount = num_check(f"How much are you using (in your units): ")

    brought = num_check(f"How much did you buy (also in your units): ")
    ...
    print(f"You have brought ingredient worth of", each_ingredient_per_dollar * amount, f"(It is calculated on the "
                                                                                        f"units you have entered)")
    print()
